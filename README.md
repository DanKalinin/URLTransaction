...
**Features:**
* Convenient [Get-Map pattern](#GetMapPattern) to construct request using factory methods which allows to hold initialization and response mapping code in single class.
...
### <a name="GetMapPattern"></a>Get-Map pattern
