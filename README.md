...
**Features:**
* Convenient [Get-Map pattern](### Get-Map pattern) to construct request using factory methods which allows to hold initialization and response mapping code in single class.
